                    ...
                    >
                      <CardContent>
                        <Typography variant="body2">
                          {reservation.loc}, {reservation.v_type}{" "}
                          {reservation.licence_no}
                        </Typography>
                        <Box
                          display="flex"
                        ...
                        >
                          <Typography variant="body2">
                            ...
                            -
                            {(() => {
                              const [hour, minutes] = reservation.exit_time
                                .split(":")
                                .map(Number);
                              const period = hour < 12 ? "AM" : "PM";
                              const formattedHour = hour % 12 || 12;
                    ...
                    <EventCard key={index}>
                      <CardContent>
                        ...
                        >
                          <Typography variant="body2">
                            {(() => {
                              const [hour, minutes] = past.entry_time
                                .split(":")
                                .map(Number);
                              const period = hour < 12 ? "AM" : "PM";
                              const formattedHour = hour % 12 || 12;
                            ...
                            -
                            {(() => {
                              const [hour, minutes] = past.exit_time
                                .split(":")
                                .map(Number);
                              const period = hour < 12 ? "AM" : "PM";
                              const formattedHour = hour % 12 || 12;
