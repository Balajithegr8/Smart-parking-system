...
const Report = ({ closeReport ,slot_no,v_type,loc,licence_no, entry_time, exit_time,email}) => {
  ...
  const onreport= () =>{
    const{email,slot_no,v_type,loc,licence_no,entry_time,exit_time,reason} = isreport;
      ...
      >
        <div className='modalRight'>
          ...
          <div className='content'>
              ...
              <br></br>
              <label htmlFor="reportReason" style={{ fontWeight: 'bold', display: 'block', marginTop: '10px' }}>
          ...
          <div className='btnContainer'>
            <button className='btnPrimary' onClick={() => { onreport();}}>
